...
**目前版本**: v7.6 EmojiGame UX 優化

### 更新歷史

#### v7.6 (2026-01-13)
- ✅ **EmojiGame 題庫可見性**：開啟「允許參賽者新增題目」後，玩家可見題庫列表
- ✅ **雙輸入框**：分開的 Emoji 欄位和答案欄位，更直覺
- ✅ **CSV 匯入**：支援 `Emoji|答案` 格式的批次匯入
- ✅ **CharadesGame 結算畫面**：多隊平手顯示 🤝、單隊冠軍顯示 🏆

#### v7.5 (2026-01-13)
- ✅ Admin 權限修復：isAdmin prop 正確傳遞
- ✅ 題庫編輯功能：完整編輯 Modal
- ✅ 權限設定：「允許參賽者新增題目」開關
