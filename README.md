...
| **題庫系統**   | 內建 2000+ 題目、可匯入 CSV、雲端題庫共享     |
...
**目前版本**: v7.4 UI 同步 & 暫停功能

### 更新歷史

#### v7.4 (2026-01-12)
- ✅ **題庫設定 UI**：新增本地題庫輸入框、代碼下載功能、雲端圖書館入口整合
- ✅ **暫停遊戲**：主持人可暫停/繼續遊戲，使用 `savedRemainingTime` 儲存剩餘時間
- ✅ **提示限制**：時間過半提示僅顯示答案第一個字
- ✅ **Git 配置**：新增 `.gitignore` 檔案
